...
It is already built and running on testnet. Forty-seven tests cover it: seven against
a live fork of mainnet chain 26514, twenty-three adversarial, six stateful
invariants over 4,096 randomised calls, and eleven on the zkVerify route. The case the reviewer raised, a clean
